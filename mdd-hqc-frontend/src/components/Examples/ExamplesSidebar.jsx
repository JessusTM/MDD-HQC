    ...
    <>
      ...
      >
        <div className="flex h-full flex-col">
          <div className="flex items-start justify-between border-b border-ctp-surface1 px-6 py-6">
            ...
            <button
              type="button"
              onClick={onClose}
              className="rounded-lg p-2 text-[#a0988c] transition-colors hover:bg-ctp-surface0 hover:text-ctp-text"
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6">
            ...
            >
              ...
              <div className="mt-5 flex items-center gap-3">
                <span className="rounded-lg border border-ctp-mauve/30 bg-ctp-mauve/10 px-3 py-1 text-xs font-bold uppercase tracking-wide text-ctp-mauve">
                  i* 2.0
                </span>
                <span className="rounded-lg border border-ctp-blue/30 bg-ctp-blue/10 px-3 py-1 text-xs font-bold uppercase tracking-wide text-ctp-blue">
                  CIM
                </span>
              </div>
            </button>
